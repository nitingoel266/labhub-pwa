...
const FunctionSelection = () => {
    ...
    return <div style={{position:"relative"}}>
        ...
        {[[{icon:DataSetupIcon,title:"Data Setup"},{icon:SensorIcon,title:"Sensor"}],[{icon:HeaterIcon,title:"Heater"},{icon:RGBSpectIcon,title:"RGB Spect"}]].map(e => (<div className={styles.ButtonWrapper}>
            {e.map(el => (
